...
/* ------------------------------------------------------------------ */
/* Demo controls under the window: a real button, revealed only once the
...
.mock-demo-button:hover {
  /* Falls back for embeds outside the landing page, which do not define the
     site's surface tokens. */
  background: var(--surface-strong, rgba(127, 137, 133, 0.16));
}

.mock-demo-button:focus-visible {
...
/* Queue and replay state is announced, not printed: on screen the queue cards
   and the button's own label already say it. */
.mock-demo-status {
  position: absolute;
  width: 1px;
  height: 1px;
